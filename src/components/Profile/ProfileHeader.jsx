...
const ProfileHeader = () => {
  return (
    <Flex
        ...
        mx={"auto"}>
            <Avatar name="Bogza Anton" src="/profilepic.png" alt="Bogza Anton Logo"/>
        </AvatarGroup>
        ...
        <VStack alignItems={"start"} gap={2} mx={"auto"} flex={1}>
            ...
            <Flex alignItems={"center"} gap={{base:2,sm:4}}>
                ...
                <Text fontSize={{base: "xs", md:"sm"}}>
                    <Text as="span" fontWeight={"bold"} mr={1}>165</Text>
                    Following
                </Text>
            </Flex>
            <Flex alignItems={"center"} gap={4}>
                <Text fontSize={"sm"} fontWeight={"bold"}>Bogza Anton</Text>
            </Flex>
